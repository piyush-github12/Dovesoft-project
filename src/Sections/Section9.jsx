...
const Section9 = () => {
  return (
    <div className=" absolute top-[50vh] h-[100vh] bg-black  z-[6]  ">
      <div
        id="foot1"
        className="w-screen min-h-[800px] h-[80vh]   max-md:h-[900px] flex max-md:flex-col bg-[#031e42] text-white px-[100px] py-[150px] max-md:py-[250px]   max-md:px-[5vw]"
      >
        ...
        <div className="w-[70%] max-md:w-full  h-full flex  gap-2 text-sm font-light">
          <div className="w-[25%] h-full ">
            ...
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">
              Intigrations
            </h2>
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">
              Business Messaging
            ...
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">Mobile App</h2>
          </div>
          <div className="w-[25%] h-full ">
            <h1 className="font-bold text-xl mb-10 max-md:mb-5  ">Learn</h1>
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">Book Demo</h2>
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">
              HubSpot Integration
            </h2>
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">
          ...
          <div className="w-[25%] h-full ">
            ...
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">About Us</h2>
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">blog</h2>
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">
              Knowledge Base
            </h2>
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">Careers</h2>
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">
              Developer Portal
            </h2>
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">
            ...
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">Case Study</h2>
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">Contact Us</h2>
            <h2 className="mb-5 max-md:mb-[0px] max-md:leading-0  max-sm:text-[10px]">API Status</h2>
          </div>
          <div className="w-[25%] h-full ">
      ...
      <div className="w-full min-h-[200px] h-[20vh] flex justify-center  text-white text-center bg-[#031e42]">
