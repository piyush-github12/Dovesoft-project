      ...
      <div id="section8" className="w-full min-h-[100vh]  z-[7]">
        <div className="w-screen px-[10vw] max-sm:px-[0]  h-fit z-[7] relative bg-white pb-[100px]  ">
          ...
          <div className="grid grid-cols-4  max-lg:grid-cols-2 gap-10 justify-items-center   max-md:px-5">
            <div className="w-[18vw]  min-h-fit max-lg:w-[30vw] max-lg:h-fit   max-sm:w-[40vw] max-sm:h-[100%] rounded-tl-[30px] p-5 max-sm:p-2 rounded-br-[30px] border-2  border-[#FF9A0D] flex flex-col items-center  gap-2">
              <img className="w-[64px] " src="./images/image 19.png" alt="" />
              <h1 className="font-bold text-2xl ">We Scale with You</h1>
            ...
            <div className="w-[18vw]  min-h-fit max-lg:w-[30vw] max-lg:h-fit   max-sm:w-[40vw] max-sm:h-[100%] rounded-tl-[30px] p-5 max-sm:p-2 rounded-br-[30px] border-2  border-[#3C3585] flex flex-col items-center  gap-2">
            ...
            <div className="w-[18vw]  min-h-fit max-lg:w-[30vw] max-lg:h-fit   max-sm:w-[40vw] max-sm:h-[100%] rounded-tl-[30px] p-5 max-sm:p-2 rounded-br-[30px] border-2  border-[#B22556] flex flex-col items-center  gap-2">
              <img className="w-[64px] " src="./images/image 19-2.png" alt="" />
              <h1 className="font-bold text-2xl ">Enterprise-grade</h1>
              <h1 className="text-lg max-sm:text-base text-center">
            ...
            <div className="w-[18vw]  min-h-fit max-lg:w-[30vw] max-lg:h-fit   max-sm:w-[40vw] max-sm:h-[100%] rounded-tl-[30px] p-5 max-sm:p-2 rounded-br-[30px] border-2  border-[#116B6B] flex flex-col items-center  gap-2">
              <img className="w-[64px] " src="./images/image 19-3.png" alt="" />
              <h1 className="font-bold text-2xl ">Compliance & developers</h1>
              <h1 className="text-lg max-sm:text-base text-center">
