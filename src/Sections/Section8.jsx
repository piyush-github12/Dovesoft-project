  ...
  return (
    <div className="w-[100vw] min-h-[100vh] relative  pt-10  bg-[#fff] ">
      <div id="section8" className="w-full min-h-[100vh]  z-[7]">
        <div className="w-screen px-[10vw]  h-fit z-[7] relative bg-white pb-[100px]  ">
          ...
          <div className="grid grid-cols-4  max-lg:grid-cols-2 gap-10 justify-items-center   max-md:px-5">
            <div className="w-[18vw]  min-h-fit max-lg:w-[30vw] max-lg:h-fit   max-sm:w-[40vw] max-sm:h-[100%] rounded-tl-[30px] p-5 rounded-br-[30px] border-2  border-[#FF9A0D] flex flex-col items-center  gap-2">
              ...
              <h1 className="text-lg max-sm:text-sm text-center">
        ...
        <div className="w-screen px-[10vw] h-fit pb-[100px] relative z-[7] bg-white rounded-b-[55px] text-white flex items-center justify-center">
          <div className="w-[100%] h-[300px]  shadow-lg shadow-[#000000b9] rounded-l-full max-md:rounded-l-[15vw] rounded-tr-full max-md:rounded-tr-[15vw]  bg-[#031e42] py-10 flex flex-col items-center justify-center gap-5">
