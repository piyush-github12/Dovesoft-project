...
const Footer = () => {
  return (
    <div>
      <div className="w-full h-fit flex max-md:flex-col bg-[#031e42] text-white px-[100px] py-[150px]  max-md:px-[5vw]">
        <div className="w-[30%] max-md:w-full h-full max-md:h-fit max-md:mb-10 ">
          ...
          <div className='w-[200px] mt-10'> <img src="./images/google.png" alt="" /></div>
          <div className='w-[200px] mt-10'> <img src="./images/apple.png" alt="" /></div>
      ...
      <div className="w-full h-fit flex justify-center text-white text-center bg-[#031e42]">
        <div className="w-[90%] border-t-2 px-32 py-5 border-white ">
          <h2 className="text-sm ">
          ...
          <h2 className="text-sm mt-5"> © 2024 Sakari, LLC All rights reserved. Privecy policy</h2>
        </div>
      </div>
    </div>
  );
