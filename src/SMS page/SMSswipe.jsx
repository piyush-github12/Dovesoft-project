...
export default function App() {
    ...
    let data2 = [
      ...
      },
      {
        ...
        para: "When a user clicks on a link in a short URL or a smart addon, the application can trace the device information...Read More",
      },
      {
        image: "./images/sec-4-3.png",
