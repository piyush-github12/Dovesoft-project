      ...
      <div className="w-screen h-fit px-[8vw] grid grid-cols-3 max-sm:grid-cols-1">
        <div className="w-[30vw] max-sm:w-full min-h-[300px] p-[20px] ">
          <img
            ...
            src="./images/intigrationimages/page3-1.svg"
            alt=""
          />
        ...
        <div className="w-[30vw] max-sm:w-full min-h-[300px] p-[20px]">
          <img
            className="w-full max-sm:w-[250px]  "
            src="./images/intigrationimages/page3-2.svg"
            alt=""
          />
          <h1 className="text-lg px-[40px] max-md:px-[20px] font-semibold mt-[20px] font-['Epilogue']">
            Cart abandonment
        ...
        <div className="w-[30vw] max-sm:w-full min-h-[300px] p-[20px]">
          <img
            className="w-full max-sm:w-[250px]  "
            src="./images/intigrationimages/page3-3.svg"
            alt=""
          />
          <h1 className="text-lg px-[40px] max-md:px-[20px] font-semibold mt-[20px] font-['Epilogue']">
...
export default Intigrationpage3