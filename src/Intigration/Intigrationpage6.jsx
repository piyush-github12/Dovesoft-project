      ...
      <div className="w-screen h-fit px-[8vw] py-[50px] grid grid-cols-3 max-sm:grid-cols-1 justify-items-center">
        <div className="w-[25vw] max-sm:w-full min-h-[300px] p-[20px] ">
          <img
            ...
            src="./images/intigrationimages/page6-1.svg"
            alt=""
          />
          <h1 className="text-lg  font-semibold mt-[10px] font-['Epilogue']">
        ...
        <div className="w-[25vw] max-sm:w-full min-h-[300px] p-[20px]">
          <img
            className="w-[100px] max-sm:w-[80px] "
            src="./images/intigrationimages/page6-2.svg"
            alt=""
          />
          <h1 className="text-lg  font-semibold mt-[10px] font-['Epilogue']">
        ...
        <div className="w-[25vw] max-sm:w-full min-h-[300px] p-[20px]">
          <img
            className="w-[100px] max-sm:w-[80px] "
            src="./images/intigrationimages/page6-3.svg"
            alt=""
          />
          <h1 className="text-lg  font-semibold mt-[10px] font-['Epilogue']">
            Content moderation
...
export default Intigrationpage6