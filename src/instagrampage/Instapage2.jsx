...
const Instapage2 = () => {
  return (
    <div className="w-screen py-[50px]">
      ...
      <div className="grid grid-cols-3 max-md:grid-cols-1 gap-10 w-screen px-[10vw] max-md:px-[5vw] justify-center">
        <div className="shadow-[0px_0px_20px_0px] shadow-[#00000083] rounded-xl w-[25vw]  max-md:w-full min-h-[250px] p-5">
